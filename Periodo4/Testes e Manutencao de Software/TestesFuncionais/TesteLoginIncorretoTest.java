...
import java.net.URL;
public class TesteLoginIncorretoTest {
  ...
  public void testeLoginIncorreto() {
    ...
    driver.findElement(By.cssSelector(".container-login100")).click();
    assertThat(driver.findElement(By.cssSelector(".flex-sb-m")).getText(), is("Login ou Senha incorreta"));
  }
}
